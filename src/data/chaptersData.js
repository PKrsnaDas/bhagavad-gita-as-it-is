export const chaptersData = [
  {
    ...
    keyTeachings: [
      ...
      "Arjuna's illusion of bodily identification",
      "The need for spiritual guidance in times of crisis",
      "The importance of accepting a spiritual master"
    ],
    theme: "Dejection and Crisis",
    acronym: "D.H.A.R.M.A",
    acronymMeaning: "Dilemma, Hesitation, Attachment, Realization, Master, Awakening",
    acronymSections: [
      {
        title: "D - Dilemma",
      ...
      {
        title: "A - Awakening",
        content: "Though not yet fully awakened, Arjuna's crisis opens the door for Krishna's teachings. This is the beginning of spiritual awakening.",
        subsections: [
          "Crisis as opportunity for growth",
          "The need for transcendental knowledge",
          "Preparing to receive Bhagavad Gita"
        ]
      }
    ],
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "The soul transmigrates from one body to another",
      "One must tolerate the dualities of material existence",
  ...
  },
  {
    ...
    english: "Karma-yoga",
    verses: 43,
    summary: "Krishna explains Karma Yoga - the yoga of selfless action. He teaches that one cannot achieve liberation by simply abandoning prescribed duties. Instead, one must perform their duties as an offering to Krishna, without attachment to the results. Prabhupada emphasizes that this is the practical application of spiritual knowledge in daily life.",
    keyTeachings: [
      "Everyone must engage in some kind of activity",
      "One should not abandon one's prescribed duties",
      "Work should be performed as a sacrifice to Vishnu",
      "Action without attachment leads to perfection"
    ],
    theme: "Selfless Service",
    acronym: "K.A.R.M.A",
    acronymMeaning: "Knowledge, Action, Renunciation, Manifestation, Awakening",
    acronymSections: [
      {
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "The ancient system of sacrifice",
      "Action, knowledge, and renunciation are connected",
      "One who understands this transcendental knowledge becomes liberated"
    ],
    theme: "Wisdom in Action",
    acronym: "T.R.A.N.S.",
    acronymMeaning: "Transcendental, Revelation, Appearance, Nature, Sacrifice",
    acronymSections: [
      {
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Liberation comes from performing prescribed duties",
      "Both action and renunciation can lead to the same goal"
    ],
    theme: "True Renunciation",
    acronym: "R.E.N.O.U.N.C.E",
    acronymMeaning: "Real, External, Nature, Offering, Understanding, Non-attachment, Consciousness, Equanimity",
    acronymSections: [
      {
      ...
      {
        title: "N - Non-attachment to Results",
        content: "One must be equipoised in success and failure. This is the hallmark of a true renunciant.",
        subsections: [
          "Equanimity in success and failure",
          "Freedom from material duality",
          "The balanced mind"
        ]
      },
      {
        title: "C - Consciousness of Krishna",
        content: "Being always conscious of Krishna is the perfection of renunciation. All work becomes spiritual when done for Krishna.",
        subsections: [
          "Krishna consciousness in all activities",
      ...
      {
        title: "E - Equilibrium",
        content: "The wise see all beings with equal vision - in Krishna. This transcendental vision is the goal of renunciation.",
        subsections: [
          "Equal vision of all beings",
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Moderation in eating, sleeping, and working is essential",
      "The yogi sees Krishna everywhere"
    ],
    theme: "Meditation and Focus",
    acronym: "M.E.D.I.T.A.T.E",
    acronymMeaning: "Mind, Environment, Discipline, Intention, Tranquility, Awareness, Transformation, Enlightenment",
    acronymSections: [
      {
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "The pure devotee is most dear to Krishna",
      "Everything is Krishna's energy"
    ],
    theme: "Divine Knowledge",
    acronym: "D.E.V.O.T.E.E",
    acronymMeaning: "Divine, Energies, Vision, Oneness, Transformation, Engagement, Experience, Eternity",
    acronymSections: [
      {
    ...
    imageUrl: "/bhagavad-gita-as-it-is/images/Chapter7.png"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Constant remembrance of Krishna is the yoga of perfection",
      "Krishna protects His devotees in all circumstances"
    ],
    theme: "Devotional Service",
    acronym: "B.H.A.K.T.I",
    acronymMeaning: "Bhakti, Hearing, Action, Knowledge, Total, Intelligence",
    acronymSections: [
      {
        title: "B - Bhakti Yoga",
      ...
      {
        title: "I - Intelligence",
        content: "One must use intelligence to engage in Krishna's service. This requires understanding Krishna's position.",
        subsections: [
          "Intelligent devotion",
          "Understanding Krishna's position",
          "Engaging in service with knowledge"
        ]
      }
    ],
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Everything glorious is Krishna's manifestation",
      "Recognizing Krishna in everything",
      "Krishna is the source of all beauty and power"
    ],
    theme: "Divine Glories",
    acronym: "O.P.U.L.E.N.C.E",
    acronymMeaning: "Opulence, Power, Understanding, Light, Energy, Nature, Consciousness, Everything",
    acronymSections: [
      {
        title: "O - Opulence",
      ...
      },
      {
        ...
        content: "The conclusion - everything that exists is Krishna's energy. By seeing this, the devotee becomes constantly Krishna conscious.",
        subsections: [
          "Everything belongs to Krishna",
          "The vision of unity",
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Time (Kala) is the destroyer of all worlds",
      "Only by Krishna's mercy can one see this form",
      "Surrender to Krishna is the only path"
    ],
    theme: "Universal Vision",
    acronym: "U.N.I.V.E.R.S.E",
    acronymMeaning: "Universal, Nature, Infinite, Vision, Energy, Revelation, Surrender, Everything",
    acronymSections: [
      {
    ...
    imageUrl: "/bhagavad-gita-as-it-is/images/Chapter11.png"
  },
  {
    id: 12,
    name: "Bhakti Yoga",
    ...
    keyTeachings: [
      ...
      "Krishna is most easily approached through devotion",
      "Devotion is the highest yoga"
    ],
    theme: "Loving Devotion",
    acronym: "D.E.V.O.T.E",
    acronymMeaning: "Devotion, Engagement, Vision, Offering, Transformation, Excellence",
    acronymSections: [
      {
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "Knowledge means understanding the distinction between matter and spirit"
    ],
    ...
    imageUrl: "/bhagavad-gita-as-it-is/images/Chapter13.png"
  },
  {
    id: 14,
    ...
    keyTeachings: [
      ...
      "Sattva-guna leads to knowledge and happiness",
      "Rajo-guna leads to attachment and material development",
      "Tamo-guna leads to ignorance and laziness"
    ],
    theme: "Three Modes of Nature",
    acronym: "G.U.N.A.S",
    acronymMeaning: "Goodness, Understanding, Nature, Action, Surrender",
    acronymSections: [
      {
  ...
  },
  {
    ...
    acronymMeaning: "Person, Ultimate, Reality, Universal, Supreme, Highest, Original, Transcendental, All, Material, All",
    acronymSections: [
      {
  ...
  },
  {
    ...
    keyTeachings: [
      ...
      "One should follow scriptural injunctions"
    ],
    theme: "Divine vs Demonic",
    acronym: "D.I.V.I.N.E",
    acronymMeaning: "Divine, Illumination, Virtue, Integrity, Nature, Enlightenment",
    acronymSections: [
      {
  ...
  },
  {
    ...
    imageUrl: "/bhagavad-gita-as-it-is/images/Chapter17.png"
  },
  {
    id: 18,
